...
class LocationService {
  ...
  static Future<List<LocationModel>> fetchLocations({String search = ''}) async {
    final uri = Uri.parse('$_baseUrl/auth/locations/list');
    ...
    if ((response.statusCode == 200 || response.statusCode == 201) &&
      ...
      throw Exception(body['message'] ?? 'Failed to load locations.');
    }
  }
}